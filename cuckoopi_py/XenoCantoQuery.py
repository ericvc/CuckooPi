#REQUIRE FFMPEG TO BE INSTALLED ON LOCAL SYSTEM
...
class XenoCantoQuery:
    ...
    def __init__(self, Genus_species: str, volume: int=100):
    ...
    def play_audio(self):
        cmd = f"ffplay {self.local_audio_file} -nodisp -autoexit -volume {self.volume}"
        os.system(cmd)
